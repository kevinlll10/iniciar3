...
def index(request):
	...
	print "before rankingExi",rankingExi
	...
	lon = len(rankingExi)
	print "rankingExi",rankingExi
	rankingExiMen=rankingExi[lon/3-3:lon/3]
	rankingExiMed=rankingExi[2*lon/3-3:2*lon/3]
	rankingExiMay=rankingExi[lon-3:lon]
	print "rankingExiMen",rankingExiMen
	print "rankingExiMed",rankingExiMed
	print "rankingExiMay",rankingExiMay
	rankingExi=list()
	...
	while inter>=1:
		...
		while flag:
			...
			i=0
			while i+inter<cant:
				if rankingPed[i].pedagogiaP>rankingPed[i+inter].pedagogiaP:
					aux=rankingPed[i]
